...
let initializeVariables = function() {
  ...
  contextMenuLinkClassName = "context-menu__empty";
  contextMenuActive = "context-menu--active";

  taskItemClassName = "del";
  menuState = 0;

  menu = document.querySelector("#trash-context-menu");
...
//empties the trash
//TODO: move to groups.js
let emptyTrash = function() {
  let trashedCards = Cards.find({groupId: 'trash'});
  trashedCards.forEach(function(card) {
    Cards.remove({_id:card._id});
  });
}

Modules.client.startTrashContextMenu = startContextMenu;
